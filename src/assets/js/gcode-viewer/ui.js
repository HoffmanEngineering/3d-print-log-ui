...
//             });
            ...
            this.worker = new Worker('assets/js/gcode-viewer/Worker.js');
...
//             chooseAccordion('fileAccordionTab');
        ...
        processOptions: function(){
			GCODE.gCodeReader.setOption({
				sortLayers: true, //document.getElementById('sortLayersCheckbox').checked,
				purgeEmptyLayers: true, // document.getElementById('purgeEmptyLayersCheckbox').checked,
				volumetricE: false,// document.getElementById('volumetricE').checked,

				filamentDia: 1.75, // Number($('#filamentDia').val()) || 1.75,
				nozzleDia: 0.4, // Number($('#nozzleDia').val()) || 0.4,
				hourlyCost: 1.0, // Number($('#hourlyCost').val()) || 1.0,
				filamentPrice: 0.05, // Number($('#filamentPrice').val()) || 0.05,

				filamentType: 'PLA', // document.getElementById('plasticABS').checked ? 'ABS' : 'PLA',
			});

			GCODE.renderer.setOption({
				moveModel: false, // document.getElementById('moveModelCheckbox').checked,
				showMoves: false, // document.getElementById('showMovesCheckbox').checked,
				showRetracts: false, // document.getElementById('showRetractsCheckbox').checked,
				differentiateColors: false, // document.getElementById('differentiateColorsCheckbox').checked,
				actualWidth: false, // document.getElementById('thickExtrusionCheckbox').checked,
				alpha: false, // document.getElementById('alphaCheckbox').checked,
				showNextLayer: false, // document.getElementById('showNextLayer').checked,
			});
